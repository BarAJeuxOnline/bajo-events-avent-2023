  ...
  return {
    ...
    shortcuts: [
      ...
      // buttons
      {
        ...
        'btn': 'rounded-2 inline-flex btn-md btn-glass shrink-0 cursor-pointer select-none flex-wrap items-center justify-center border-transparent text-center btn-animation',
